...
function Back()
	...
	<div class="container col-sm-offset-2" >
       ...
       <input type="button"  id="btn" name="btn" style="font-size: 25" class="btn btn-large btn-success glyphicon glyphicon-save  button-height-width"  onclick="delProduct()" value="Submit">
