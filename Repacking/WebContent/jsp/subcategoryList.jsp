...
<%@page import="com.Fertilizer.dao.SubcategoryDetailsDao"%>
<%@page import="com.Fertilizer.dao.CategoryDetailsDao"%>
<%@page import="com.Fertilizer.bean.GetSubcategoryDetails"%>
		...
		<title>Category List</title>
  		...
  		<script type="text/javascript">
  			...
  			function deletProduct()
  	   		 {
  	   		 window.location = "deleteSub-Cat.jsp";
  	   		 }
...
<body id="dt_example" style="min-height:300px;">
	...
	<%
	SubcategoryDetailsDao dao=new SubcategoryDetailsDao();
	List list12=dao.getSubCategoryName();
	%>
			...
			<tbody>
   				<%
					for(int i=0;i<list12.size();i++){
						GetSubcategoryDetails sr=(GetSubcategoryDetails)list12.get(i);
				%>
	...
	<div class="wrapper" align="center">
		...
		<input type="button" value="Delete Sub-Category" id="listBtn2" style="font-size: 25" class="btn btn-primary" onclick="deletProduct()" />
	</div>
