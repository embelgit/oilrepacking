...
public class EmployeePaymentBean implements Serializable{
			...
			public EmployeePaymentBean(Date insertDate,
					Long pkEmployeePaymentId, Double credit, String personName,
					String reason, Long fk_employee_id, String chequeNum,
					Long cardNum, Long accNum, String paymentMode,
					String nameOnCheck, String bankName, String paymentType) {
				super();
				this.insertDate = insertDate;
				this.pkEmployeePaymentId = pkEmployeePaymentId;
				this.credit = credit;
