...
<script type="text/javascript" src="<c:url value="/resource/js/jquery-1.9.0.min.js"/>" ></script>
<script type="text/javascript" src="<c:url value="/resource/js/jquery.nivo.slider.js"/>" ></script>
...
<div class="wrap">
	<div class="header">
		<div class="logo">
			<h1><a href="index.html"><img src="<c:url value="/resource/images/logo.png"  />"  alt=""></a></h1>
		</div>
	...
	<div class='h_btm'>
		<div class='cssmenu'>
			<ul>
			    ...
			    <li><a href='staffl.htm'><span>Staff</span></a></li>
	...
	<!------ Slider------------>
		  <div class="slider">
	      	<div class="slider-wrapper theme-default">
	            <div id="slider" class="nivoSlider">
	                <img src="<c:url value="/resource/images/banner1.jpg" />"  data-thumb="/resource/images/1.jpg" alt="" />
	                <img src="<c:url value="/resource/images/banner2.jpg" />"  data-thumb="/resource/images/2.jpg" alt="" />
	                <img src="<c:url value="/resource/images/banner3.jpg" />" data-thumb="/resource/images/3.jpg" alt="" />
	            </div>
	        </div>
	      </div>
		<!------End Slider ------------>
		<div class="grids_1_of_3">
				<div class="grid_1_of_3 images_1_of_3">
					  <img src="<c:url value="/resource/images/icon1.jpg" />" >
				...
				<div class="grid_1_of_3 images_1_of_3">
					  <img  src="<c:url value="/resource/images/icon2.jpg" />">
					  <h3>Lorem Ipsum is simply</h3>
					  <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore pariatur.</p>
				</div>
				<div class="grid_1_of_3 images_1_of_3">
					  <img src="<c:url value="/resource/images/icon3.jpg"/>">
					  <h3>Lorem Ipsum is simply</h3>
					  <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore pariatur.</p>
				</div>
				<div class="clear"></div>
	...
	<div class="wrap">
		 <div class="main">
					<div class="gallery">
						...
						<ul>
							<li><a class="gallery-img" href="/resource/images/gallery1.jpg"><img src="<c:url value="/resource/images/gallery1.jpg" />" alt=""></a><a href="#"></a></li>
							<li><a class="gallery-img" href="/resource/images/gallery2.jpg"><img src="<c:url value="/resource/images/gallery2.jpg" />" alt=""></a><a href="#"></a></li>
							<li><a class="gallery-img" href="/resource/images/gallery3.jpg"><img src="<c:url value="/resource/images/gallery3.jpg" />" alt=""></a><a href="#"></a></li>
							<li><a class="gallery-img" href="/resource/images/gallery4.jpg"><img src="<c:url value="/resource/images/gallery4.jpg" />" alt=""></a><a href="#"></a></li>
							<li><a class="gallery-img" href="/resource/images/gallery4.jpg"><img src="<c:url value="/resource/images/gallery4.jpg" />"alt=""></a><a href="#"></a></li>
							<li><a class="gallery-img" href="/resource/images/gallery3.jpg"><img src="<c:url value="/resource/images/gallery3.jpg" />" alt=""></a><a href="#"></a></li>
							<li><a class="gallery-img" href="/resource/images/gallery5.jpg"><img src="<c:url value="/resource/images/gallery5.jpg" />" alt=""></a><a href="#"></a></li>
							<li><a class="gallery-img" href="/resource/images/gallery6.jpg"><img src="<c:url value="/resource/images/gallery6.jpg" />" alt=""></a><a href="#"></a></li>
						</ul>
					</div>
					<script type="text/javascript" src="<c:url value="/resource/js/jquery.lightbox.js"/>"></script>
				    <link rel="stylesheet" type="text/css" href="<c:url value="/resource/css/lightbox.css"/>" media="screen">
				  	<script type="text/javascript">
				    $(function() {
